...
class DDAQAgent(Agent):
    """
    Parameterized DDAQ Agent.
    Code inherits from TD3AQ.
    ...
    def __init__(self,
                 ...
                 clip_grad=10,
                 policy_freq=1,  # no delayed policy updates in DDAQ
        ...
        super(DDAQAgent, self).__init__(observation_space, action_space)
...
# P-DDPG
    ...
    def _optimize_td_loss(self):
        ...
        with torch.no_grad():
            ...
            pred_Q_a = self.actor_target.Q1(next_states, pred_next_action_parameters)
        ...
        q_values = self.actor.Q1(states, action_parameters)
